...
const Persons = ({ Filter, List, setList }) => {
    ...
    const filteredpersons = Filter === "" ? List : List.filter((person) => person.name.toLowerCase().includes(Filter.toLowerCase()));
    return (
        <div>
...
const App = () => {
            ...
            if (!window.confirm(`${newName} is already added to phonebook, replace the old number with a new one?`)) {
                ...
                personsService
                    ...
                    .then((thisperson) => {
                        ...
                        setNewNotification(`Changed ${changedPerson.name}'s number to ${changedPerson.number}`);
    ...
    return (
        <div>
            ...
            <PersonForm Name={newName} PN={newPN} ChangeName={handleOnChangeName} ChangePN={handleOnChangePN} handleButton={handleAddButton} />
